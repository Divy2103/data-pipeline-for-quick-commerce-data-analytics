...
from (
    ...
    from @stage_sch.aws_s3_stage/order_items.csv t
)
...
-- Create the fact table for order_item
...
-- MERGE statement to load data from clean layer to consumption layer with SCD Type 2 handling
MERGE INTO 
