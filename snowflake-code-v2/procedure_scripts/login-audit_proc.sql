...
WHEN MATCHED AND (
    ...
    null equal_null(target.device_interface, source.device_interface) OR
    null equal_null(target.mobile_device_name, source.mobile_device_name) OR
    null equal_null(target.web_interface , source.web_interface) OR
