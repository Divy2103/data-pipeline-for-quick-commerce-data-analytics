...
-- truncate table swiggy_db.stage_sch.orders;
-- truncate table swiggy_db.clean_sch.orders;
-- truncate table swiggy_db.consumption_sch.orders_fact;

create or replace procedure swiggy_db.stage_sch.load_orders_data(stage_name STRING)
RETURNS TABLE()
LANGUAGE SQL
AS
$$
...
call swiggy_db.stage_sch.load_orders_data('@swiggy_db.STAGE_SCH.AWS_S3_STAGE/2025/4/9/orders_new.csv');
